...
const questions = [
    {
        ...
        "questions": [
            ...
            {
                "question": "What is the purpose of the 'npm install' command?",
                "options": ["Initializes a new Node.js project", "Installs dependencies listed in package.json", "Uninstalls a package", "Runs the project"],
                "correctAnswer": 1
            },
            {
            ...
            },
            {
                ...
                "options": ["A method to define styles", "An object to store component's dynamic data and control its behavior", "A type of function", "A built-in library"],
                "correctAnswer": 1
            },
            {
                "question": "Which of the following is used to handle asynchronous operations in JavaScript?",
                "options": ["Promise", "Callback", "Loop", "Function"],
                "correctAnswer": 0
            },
            {
                "question": "What does the 'res.send()' function do in Express.js?",
                "options": ["Sends a response to the client", "Defines a route", "Handles errors", "Starts the server"],
                "correctAnswer": 0
            }
        ]
    },

    {
        ...
        "questions": [
            ...
            },
            {
                ...
                "options": ["Alps", "Pyrenees", "Appalachians", "Carpathians"],
                "correctAnswer": 1
            }
        ]
    },
...

    {
        ...
        "questions": [
            ...
            {
                "question": "Which superhero is known for using a shield as his main weapon?",
                "options": ["Batman", "Captain America", "Superman", "Wolverine"],
                "correctAnswer": 1
            }
        ]
    },
